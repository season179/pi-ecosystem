...
- **Missing/invalid policy, eligible external harness, image/risky task, fallback, explicit override, or policy edits:** read [Routing decisions](references/routing.md) before selecting or launching that route.
